...
MEXICAN.ATLANTA.Products.Survey2<-MEXICAN.ATLANTA.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
BARGRILL.ATLANTA.Products.Survey1<-BARGRILL.ATLANTA.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.ATLANTA.Products.Survey1,'BARGRILL.ATLANTA.Products.Survey1.csv')
BARGRILL.ATLANTA.Products.Survey2<-BARGRILL.ATLANTA.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
MEXICAN.AUSTIN.Products.Survey1<-MEXICAN.AUSTIN.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.AUSTIN.Products.Survey1,'MEXICAN.AUSTIN.Products.Survey1.csv')
MEXICAN.AUSTIN.Products.Survey2<-MEXICAN.AUSTIN.Products[(floor(tool/b))+1:tool,]
#Column name change
...
b<-2
BARGRILL.AUSTIN.Products.Survey1<-BARGRILL.AUSTIN.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.AUSTIN.Products.Survey1,'BARGRILL.AUSTIN.Products.Survey1.csv')
BARGRILL.AUSTIN.Products.Survey2<-BARGRILL.AUSTIN.Products[(floor(tool/b))+1:tool,]
#Column name change
...
b<-2
MEXICAN.CINCINNATI.Products.Survey1<-MEXICAN.CINCINNATI.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.CINCINNATI.Products.Survey1,'MEXICAN.CINCINNATI.Products.Survey1.csv')
MEXICAN.CINCINNATI.Products.Survey2<-MEXICAN.CINCINNATI.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
BARGRILL.CINCINNATI.Products.Survey1<-BARGRILL.CINCINNATI.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.CINCINNATI.Products.Survey1,'BARGRILL.CINCINNATI.Products.Survey1.csv')
BARGRILL.CINCINNATI.Products.Survey2<-BARGRILL.CINCINNATI.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
BARGRILL.COLUMBIA.Products.Survey1<-BARGRILL.COLUMBIA.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.COLUMBIA.Products.Survey1,'BARGRILL.COLUMBIA.Products.Survey1.csv')
BARGRILL.COLUMBIA.Products.Survey2<-BARGRILL.COLUMBIA.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
MEXICAN.COLUMBIA.Products.Survey1<-MEXICAN.COLUMBIA.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.COLUMBIA.Products.Survey1,'MEXICAN.COLUMBIA.Products.Survey1.csv')
MEXICAN.COLUMBIA.Products.Survey2<-MEXICAN.COLUMBIA.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
MEXICAN.DENVER.Products.Survey1<-MEXICAN.DENVER.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.DENVER.Products.Survey1,'MEXICAN.DENVER.Products.Survey1.csv')
MEXICAN.DENVER.Products.Survey2<-MEXICAN.DENVER.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
BARGRILL.DENVER.Products.Survey1<-BARGRILL.DENVER.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.DENVER.Products.Survey1,'BARGRILL.DENVER.Products.Survey1.csv')
BARGRILL.DENVER.Products.Survey2<-BARGRILL.DENVER.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
BARGRILL.METRO.NEW.YORK.Products.Survey1<-BARGRILL.METRO.NEW.YORK.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.METRO.NEW.YORK.Products.Survey1,'BARGRILL.METRO.NEW.YORK.Products.Survey1.csv')
BARGRILL.METRO.NEW.YORK.Products.Survey2<-BARGRILL.METRO.NEW.YORK.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
MEXICAN.METRO.NEW.YORK.Products.Survey1<-MEXICAN.METRO.NEW.YORK.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.METRO.NEW.YORK.Products.Survey1,'MEXICAN.METRO.NEW.YORK.Products.Survey1.csv')
MEXICAN.METRO.NEW.YORK.Products.Survey2<-MEXICAN.METRO.NEW.YORK.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
BARGRILL.MINNESOTA.Products.Survey1<-BARGRILL.MINNESOTA.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.MINNESOTA.Products.Survey1,'BARGRILL.MINNESOTA.Products.Survey1.csv')
BARGRILL.MINNESOTA.Products.Survey2<-BARGRILL.MINNESOTA.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-2
MEXICAN.MINNESOTA.Products.Survey1<-MEXICAN.MINNESOTA.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.MINNESOTA.Products.Survey1,'MEXICAN.MINNESOTA.Products.Survey1.csv')
MEXICAN.MINNESOTA.Products.Survey2<-MEXICAN.MINNESOTA.Products[(floor(tool/b))+1:max(tool),]
#Column name change
...
b<-3
BARGRILL.SAN.FRANCISCO.Products.Survey1<-BARGRILL.SAN.FRANCISCO.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.SAN.FRANCISCO.Products.Survey1,'BARGRILL.SAN.FRANCISCO.Products.Survey1.csv')
BARGRILL.SAN.FRANCISCO.Products.Survey2<-BARGRILL.SAN.FRANCISCO.Products[(floor(tool/b))+1:floor(2*tool/b),]
#Column name change
write.csv(BARGRILL.SAN.FRANCISCO.Products.Survey2,'BARGRILL.SAN.FRANCISCO.Products.Survey2.csv')
BARGRILL.SAN.FRANCISCO.Products.Survey3<-BARGRILL.SAN.FRANCISCO.Products[(floor(2*tool)/b)+1:max(tool),]
#Column name change
...
b<-3
MEXICAN.SAN.FRANCISCO.Products.Survey1<-MEXICAN.SAN.FRANCISCO.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.SAN.FRANCISCO.Products.Survey1,'MEXICAN.SAN.FRANCISCO.Products.Survey1.csv')
MEXICAN.SAN.FRANCISCO.Products.Survey2<-MEXICAN.SAN.FRANCISCO.Products[(floor(tool/b))+1:floor(2*tool/b),]
#Column name change
write.csv(MEXICAN.SAN.FRANCISCO.Products.Survey2,'MEXICAN.SAN.FRANCISCO.Products.Survey2.csv')
MEXICAN.SAN.FRANCISCO.Products.Survey3<-MEXICAN.SAN.FRANCISCO.Products[(floor(2*tool)/b)+1:max(tool),]
#Column name change
...
b<-4
BARGRILL.KNOXVILLE.Products.Survey1<-BARGRILL.KNOXVILLE.Products[1:floor(tool/b),]
#Column name change
write.csv(BARGRILL.KNOXVILLE.Products.Survey1,'BARGRILL.KNOXVILLE.Products.Survey1.csv')
BARGRILL.KNOXVILLE.Products.Survey2<-BARGRILL.KNOXVILLE.Products[(floor(tool/b))+1:floor(2*tool/b),]
#Column name change
write.csv(BARGRILL.KNOXVILLE.Products.Survey2,'BARGRILL.KNOXVILLE.Products.Survey2.csv')
BARGRILL.KNOXVILLE.Products.Survey3<-BARGRILL.KNOXVILLE.Products[(floor(2*tool)/b)+1:floor(3*tool/b),]
#Column name change
write.csv(BARGRILL.KNOXVILLE.Products.Survey3,'BARGRILL.KNOXVILLE.Products.Survey3.csv')
BARGRILL.KNOXVILLE.Products.Survey4<-BARGRILL.KNOXVILLE.Products[(floor(3*tool/b))+1:tool,]
#Column name change
...
b<-4
MEXICAN.KNOXVILLE.Products.Survey1<-MEXICAN.KNOXVILLE.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.KNOXVILLE.Products.Survey1,'MEXICAN.KNOXVILLE.Products.Survey1.csv')
MEXICAN.KNOXVILLE.Products.Survey2<-MEXICAN.KNOXVILLE.Products[(floor(tool/b))+1:floor(2*tool/b),]
#Column name change
write.csv(MEXICAN.KNOXVILLE.Products.Survey2,'MEXICAN.KNOXVILLE.Products.Survey2.csv')
MEXICAN.KNOXVILLE.Products.Survey3<-MEXICAN.KNOXVILLE.Products[(floor(2*tool)/b)+1:floor(3*tool/b),]
#Column name change
write.csv(MEXICAN.KNOXVILLE.Products.Survey3,'MEXICAN.KNOXVILLE.Products.Survey3.csv')
MEXICAN.KNOXVILLE.Products.Survey4<-MEXICAN.KNOXVILLE.Products[(floor(3*tool/b))+1:tool,]
#Column name change
...
b<-4
BARGRILL.PHILADELPHIA.Products.Survey1<-BARGRILL.PHILADELPHIA.Products[1:82,]
#Column name change
write.csv(BARGRILL.PHILADELPHIA.Products.Survey1,'BARGRILL.PHILADELPHIA.Products.Survey1.csv')
BARGRILL.PHILADELPHIA.Products.Survey2<-BARGRILL.PHILADELPHIA.Products[83:165,]
#Column name change
write.csv(BARGRILL.PHILADELPHIA.Products.Survey2,'BARGRILL.PHILADELPHIA.Products.Survey2.csv')
BARGRILL.PHILADELPHIA.Products.Survey3<-BARGRILL.PHILADELPHIA.Products[166:250,]
#Column name change
write.csv(BARGRILL.PHILADELPHIA.Products.Survey3,'BARGRILL.PHILADELPHIA.Products.Survey3.csv')
BARGRILL.PHILADELPHIA.Products.Survey4<-BARGRILL.PHILADELPHIA.Products[251:323,]
#Column name change
...
b<-4
MEXICAN.PHILADELPHIA.Products.Survey1<-MEXICAN.PHILADELPHIA.Products[1:floor(tool/b),]
#Column name change
write.csv(MEXICAN.PHILADELPHIA.Products.Survey1,'MEXICAN.PHILADELPHIA.Products.Survey1.csv')
MEXICAN.PHILADELPHIA.Products.Survey2<-MEXICAN.PHILADELPHIA.Products[(floor(tool/b))+1:floor(2*tool/b),]
#Column name change
write.csv(MEXICAN.PHILADELPHIA.Products.Survey2,'MEXICAN.PHILADELPHIA.Products.Survey2.csv')
MEXICAN.PHILADELPHIA.Products.Survey3<-MEXICAN.PHILADELPHIA.Products[(floor(2*tool)/b)+1:floor(3*tool/b),]
#Column name change
write.csv(MEXICAN.PHILADELPHIA.Products.Survey3,'MEXICAN.PHILADELPHIA.Products.Survey3.csv')
MEXICAN.PHILADELPHIA.Products.Survey4<-MEXICAN.PHILADELPHIA.Products[(floor(3*tool/b))+1:tool,]
#Column name change
